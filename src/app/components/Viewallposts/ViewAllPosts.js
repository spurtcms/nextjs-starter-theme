      ...
      <Post data={data} activeIndex={0}/>
          ...
          <ViewAllSkeleton />
            ...
            <Image
                ...
                /><span>Previous</span></button>{console.log(parseInt(page),postes?.ChannelEntriesList?.count,parseInt(page)+parseInt(page),postes?.ChannelEntriesList?.count,"hduhee833")}
