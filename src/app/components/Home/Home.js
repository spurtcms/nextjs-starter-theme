...
export default function HomePage({postdatas}) {
      ...
      <Banner bannerShow={bannerShow}router={router} />:<BannerSkeleton />} */}
        ...
        <div className="md:lg-0">         
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-20 gap-y-8 mb-10">
           ...
           index<4&&
           <Post data={data} activeIndex={0} scrollX={0} />
          ...
          <>
          {postdatas?.channelEntriesList?.channelEntriesList?.length>4&&<>
          ...
          {postdatas?.channelEntriesList?.channelEntriesList?.length>6&& 
